...
class Servico
{
     ...
     * @Assert\NotBlank(message="Campo título não pode ser nulo")
     * @Assert\Length(min="40", minMessage="Título deve ter no mínimo {{ limit }} caracteres", max="255", maxMessage="Título deve ter no máximo {{ limit }} caracteres")
     */
    private $titulo;
     ...
     * @Assert\NotBlank(message="Campo descrição não pode ser nulo")
     */
    private $descricao;
    ...
    /**
     * @ORM\Column(type="integer")
     * @Assert\NotBlank(message="Prazo de entrega não pode ser nulo")
     */
    private $prazo_entrega;

    /**
     * @ORM\Column(type="string", length=1, options={"comment": "Usar P para publicado, A para Em Análise, I para Inativo, E para Excluido, R para Rejeitado"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Usuario", inversedBy="yes")
     */
    private $usuario;
